...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sdv-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14687&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sdv-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sdv` can be installed with:

```
conda install sdv
```

It is possible to list all of the versions of `sdv` available on your platform with:
